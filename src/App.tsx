...
const AEModePanel = lazy(() => import("./modules/ae-exporter/components/AEModePanel"));
					...
					<Flex direction="column" height="100vh">
						...
						<Box flexGrow="1" overflow="hidden">
							<AnimatePresence mode="wait">
								{toolMode !== ToolMode.Preview && toolMode !== ToolMode.AE && (
								...
								{toolMode === ToolMode.AE && enableColorFeatures && (
									<SuspensePlaceHolder key="ae">
										<Box height="100%" key="ae" p="2" asChild>
											<motion.div
												layout="position"
												initial={{ opacity: 0 }}
												animate={{ opacity: 1 }}
